$ cat input3.smt2
  ...
  iter(1)= (and
             ...
             (<= (* (* (- 1) 1) i6) 5)
             (<= (* (* (- 1) 1) it140) (* (- 1) 1)))
  Something ready to substitute:  it359 -> (* (- 1) i3 (* (- 1) 1)); it360 ->
                                 (* (- 1) i3 (* (- 1) 1)); it361 -> (* (- 1) i7
                                                                    (* (- 1) 1)); it362 ->
                                 (* (- 1) i6 (* (- 1) 1)); it363 -> (* (- 1) i7
                                                                    (* (- 1) 1));
  iter(2)= (and
             ...
             (<= (* (- 1) i6) 5)
             (<= (* (- 1) it140) (- 1)))
  Something ready to substitute:  it358 -> (+ 3 i2); it359 -> (* (- 1) i3
                                                              (* (- 1) 1)); it360 ->
                                 (* (- 1) i3 (* (- 1) 1)); it361 -> (* (- 1) i7
                                                                    (* (- 1) 1)); it362 ->
                                 (* (- 1) i6 (* (- 1) 1)); it363 -> (* (- 1) i7
  ...
  iter(3)= (and
             ...
             (<= (+ (* i7 (* (- 1) 1)) (* (- 1) (exp (* i6 (* (- 1) 1)) 5))
                 (exp (* i3 (* (- 1) 1)) 2)) (- 1))
             (<= (+ (* (- 3) it376 (exp 9 (+ (- 1) it140)))
                 (* (- 3) (exp 9 (+ (- 1) it140)) (exp (* i6 (* (- 1) 1)) 3))
                 (* (- 1) (exp (* i6 (* (- 1) 1)) 5))
                 (* 16 (exp 4 (+ (* (- 1) 2) (* it140 2)))
                 (exp (* i3 (* (- 1) 1)) 2)) (exp (* i6 (* (- 1) 1)) 3)) (- 1))
             (<= (+ (* (- 1) it376) (* (- 1) (exp (* i6 (* (- 1) 1)) 5))
                 (* 4 (exp (* i3 (* (- 1) 1)) 2))) (- 1))
             (<= (+ (* (- 1) it376 (exp 9 (+ (- 1) it140)))
                 (* (- 1) (exp 9 (+ (- 1) it140)) (exp (* i6 (* (- 1) 1)) 3))
                 (* (- 1) (exp (* i6 (* (- 1) 1)) 5))
                 (* 4 (exp 4 (+ (* (- 1) 2) (* it140 2)))
                 (exp (* i3 (* (- 1) 1)) 2)) (exp (* i6 (* (- 1) 1)) 3)) (- 1))
             (<= (* (- 1) i6) 5)
  ...
  iter(4)= (and
             ...
             (<= (+ (* (- 1) (exp (* i6) 3))
                 ...
                 (* (* (* (* 2 (exp (* (- 1) i6 (* (- 1) 1)) 3)) (- 1))
                    (exp 9 (+ (- 1) it140)))
                 (- 1)) (* (exp 9 (+ (- 1) it140)) (exp (* i6) 3))
                 (exp (* i6) 5)) (- 1))
             (<= (+ (* 4 (exp (* i3) 2))
                 (* (* (* (- 3) (* (- 1) i7 (* (- 1) 1))) (- 1)) (- 1))
                 (* (* (* 2 (exp (* (- 1) i6 (* (- 1) 1)) 3)) (- 1)) (- 1))
                 (exp (* i6) 5)) (- 1))
             (<= (* (- 1) i6) 5)
             (<= (* (- 1) it140) (- 1)))
  iter(5)= (and

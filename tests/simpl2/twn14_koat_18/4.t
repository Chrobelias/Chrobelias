$ cat input4.smt2
  ...
  Simplify step: ((= (+ it376 (* (- 3) i7) (* 2 (exp i6 3))) 0) & (= (+
                                                                     (* (- 2)
                                                                     i3)
                                                                     (* 2 i3)) 0) & (<= i6 5) & (<= 1 i3) & (<= 1
  (* 2 i3)) & (<= 1 (* 4 i3)) & (<= (+ (* (- 3) it376
                                    ...
                                    (exp i6 5)) (* (- 1))) & (<= (+ (* (- 1)
                                                                 ...
                                                                 (exp i3 2)
                                                                 (exp i6 5))
  (* (- 1))) & (<= (+ (* (- 1) it376) (exp i6 5) (exp (* (- 2) i3) 2))
  (* (- 1))) & (<= (+ (* (- 1) it376 (exp 9 (+ (* (- 1)) it140)))
                   (* (- 1) (exp i6 3))
                   (* (exp i6 3) (exp 9 (+ (* (- 1)) it140)))
  ...
  Simplify step: ((= (+ it376 (* (- 3) i7) (* 2 (exp i6 3))) 0) & (= (+
                                                                     ...
                                                                     i3)
                                                                     (* 2 i3)) 0) & (<= i6 5) & (<= 1 i3) & (<= 1
  (* 2 i3)) & (<= 1 (* 4 i3)) & (<= (+ (* (- 3) it376 (exp 9 (+ (- 1) it140)))
                                    (* (- 1) (exp i6 3))
                                    ...
                                    (exp i6 5)) (- 1)) & (<= (+ (* (- 1) i7)
                                                             (exp i3 2)
                                                             (exp i6 5)) (- 1)) & (<=
  (+ (* (- 1) it376) (exp i6 5) (exp (* (- 2) i3) 2)) (- 1)) & (<= (+ (* (- 1)
                                                                      it376
                                                                      (exp 9
                                                                      (+ (- 1)
                                                                      it140)))
  ...
  Simplified expression: (and
                           ...
                           (<= (+ (* (- 3) it376 (exp 9 (+ (- 1) it140)))
                               ...
                               (* 3 (exp i6 3) (exp 9 (+ (- 1) it140)))
                               (* 4 (exp (* (- 2) i3) 2)
                               (exp (exp 4 (+ (- 1) it140)) 2)) (exp i6 5)) (- 1))

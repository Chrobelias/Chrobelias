  ...
  [+simpl]
    iter(5)= (and
             ...
             (<= (+ 3 (* (- 1) i10)) 0)
             (<= (+ 13 (* (- 1) it5)) 0)
             (<= (+ (* (- 1) i10) (* (- 1) 2) (* (* 2 (exp 2 it147)) 2)) 0)
             (<= (+ (* (- 1) it14) (* (- 1) 2) (* (* 2 (exp 2 it147)) 2)) 0))
  [+simpl]
    iter(6)= (and
             (= (+ (- 13) it5) 0)
             (= (+ 2 (* (- 1) 2) (* (* 2 (exp 2 it147)) 2)
                (* (- 4) (exp 2 it147))) 0)
             (= (+ 13 (* (- 1) it5)) 0)
             (= (+ it153 (* (- 1) it4)) 0)
             (= (+ (* (- 1) (- 1)) it157 (* (* 2 (exp 2 it147)) (- 1))) 0)

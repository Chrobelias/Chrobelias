  ...
  [+simpl]
    Something ready to substitute
        ...
        it171 -> it155;
        it172 -> it156;
        it173 -> (+ (- 1) (* it11 (exp 2 it147)) (exp 2 it147));
        it174 -> it158;
        it175 -> it159;
        it176 -> it160;
        it215 -> 16;
  ...
  [+simpl]
    iter(3)= (and
             ...
             (= (+ (* (- 2) (- 1)) it154 (* (* it11 (exp 2 it147)) (- 1))
                (* (exp 2 it147) (- 1))) 0)
             (= (+ (* (- 2) it173) it218) 0)
             (= (+ (* (- 1) (- 1)) it155 (* (* it11 (exp 2 it147)) (- 1))
                (* (exp 2 it147) (- 1))) 0)
             (= (+ (* (- 1) (- 1)) it158
                (* (* it11 (exp 2 (+ (- 1) it147))) (- 1))
                (* (exp 2 (+ (- 1) it147)) (- 1))) 0)
             (= (+ (* (- 1) (- 1)) it159 (* (* it11 (exp 2 it147)) (- 1))
                (* (exp 2 it147) (- 1))) 0)
             (= (+ (* (- 1) (- 1)) it173 (* (* it11 (exp 2 it147)) (- 1))
                (* (exp 2 it147) (- 1))) 0)
             (= (+ (* (- 1) i10) it14) 0)
             (= (+ (* (- 1) it14) it160) 0)
             (= (+ (* (- 1) it153) it169) 0)
  ...
  [+simpl]
    iter(4)= (and
             ...
             (= (+ (* 1 (- 1)) it219 (* (* 2 it173) (- 1))) 0)
             (= (+ (* 2 (- 1)) it216 (* it152 (- 1))) 0)
             (= (+ (* 2 it173) (* (- 1) (- 2)) (* (* it11 (exp 2 it147)) (- 2))
                (* (exp 2 it147) (- 2))) 0)
             (= (+ (* 2 it173) (* (* (- 1) 2) (- 1))
                (* (* (* it11 (exp 2 it147)) 2) (- 1))
                (* (* (exp 2 it147) 2) (- 1))) 0)
             (= (+ (* it11 (exp 2 it147)) (* (- 1) (exp 2 it147))) 0)
             (= (+ (* it11 (exp 2 (+ (- 1) it147))) (* (- 1) (exp 2 it147))
                (exp 2 (+ (- 1) it147))) 0)
             ...
             (<= (+ 3 (* (- 1) i10)) 0)
             (<= (+ 13 (* (- 1) it5)) 0)
             (<= (+ (* (- 1) it14) (* (- 1) 2) (* (* it11 (exp 2 it147)) 2)
                 (* (exp 2 it147) 2)) 0)
             (<= (+ (* (- 1) it160) (* (- 1) 2) (* (* it11 (exp 2 it147)) 2)
                 (* (exp 2 it147) 2)) 0))
  [+simpl]
    iter(5)= (and
             (= (+ (- 13) it5) 0)
             (= (+ 2 (* (- 1) 2) (* (* it11 (exp 2 it147)) 2)
                (* (exp 2 it147) 2) (* (- 4) (exp 2 it147))) 0)
             (= (+ 13 (* (- 1) it5)) 0)
             (= (+ it153 (* (- 1) it4)) 0)
             (= (+ (* (- 1) (- 1)) it158
                (* (* it11 (exp 2 (+ (- 1) it147))) (- 1))

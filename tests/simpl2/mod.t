  ...
  Simplify step: ((= r1 42) & (= (str.to.int x) (+ (* 11111 q2) 42)) & (<=
  (+ 1 r1) 11111) & (<= 0 r1))
  Simplify step: ((= r1 42) & (= (str.to.int x) (+ 42 (* 11111 q2))) & (<=
  (+ 1 r1) 11111) & (<= 0 r1))
  Simplify step: ((= r1 42) & (= (str.to.int x) (+ 42 (* 11111 q2))) & (<=
  (+ 1 r1) 11111) & (<= 0 r1))
...
$ cat 1.smt2
  ...
  Simplify step: ((= r3 0) & (= r1 (+ (* 417677 q4) 0)) & (<= (+ 1 r3) 417677) & (<= 0 r3) & (= (str.to.int x)
  (+ (* 442271 q2) r1)) & (<= (+ 1 r1) 442271) & (<= 0 r1))
  Simplify step: ((= r3 0) & (= r1 (+ (* 417677 q4))) & (<= (+ 1 r3) 417677) & (<= 0 r3) & (= (str.to.int x)
  (+ (* 442271 q2) r1)) & (<= (+ 1 r1) 442271) & (<= 0 r1))
  Simplify step: ((= r3 0) & (= r1 (* 417677 q4)) & (<= (+ 1 r3) 417677) & (<= 0 r3) & (= (str.to.int x)
  (+ (* 442271 q2) r1)) & (<= (+ 1 r1) 442271) & (<= 0 r1))
  Simplify step: ((= r3 0) & (= r1 (* 417677 q4)) & (<= (+ 1 r3) 417677) & (<= 0 r3) & (= (str.to.int x)

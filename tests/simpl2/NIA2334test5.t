  ...
  Post-simplification: (and
                         ...
                         (<= (+ (* (- 77280) x1) (* (- 26192) x3)
                             (* (- 4662) x4) (* 5594 x5) (* 12387 x2)) 88727)
                         (<= (+ (* (- 73696) x2) (* (- 69958) x1)
                             (* (- 54064) x5) (* (- 38784) x4) (* 55275 x3)) (- 717))
                         (<= (+ (* (- 55318) x3) (* (- 42327) x5)
                             (* (- 33357) x2) (* (- 96) (exp 2 x1))
                             (* 40 (exp 2 x2)) (* 16322 x4) (* 75146 x1)) (- 54594))
                         (<= (+ (* (- 53824) x5) (* (- 11652) x1)
                             (* (- 73) (exp 2 x1)) (* 5 (exp 2 x2))
                             (* 75317 x3) (* 87603 x4) (* 91714 x2)) 66490)
                         (<= (+ (* (- 41491) x3) (* 52186 x4) (* 85893 x5)
                             (* 86806 x1) (* 95727 x2)) (- 55013))
                         (<= (+ (* (- 69) (exp 2 x2)) (* 38 (exp 2 x1))
                             (* 4945 x4) (* 52371 x5) (* 70809 x1) (* 77330 x2)
                             (* 91984 x3)) (- 55034)))

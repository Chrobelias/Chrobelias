  ...
  iter(1)= (and
             ...
             (= eeb3 123)
             (= (str.from_int eeb1) (str.from_int eeb5)))
  Something ready to substitute:  eeb3 -> 123; eeb6 -> eeb2; eeb7 -> 321; eeb8 ->
                                 eeb4;
  iter(2)= (and
  ...
  iter(0)= (and
             (and
               ...
               (= (* 1 eeb5) (* 1 (+ (* 1 eeb4) (* 1 (* 123 (exp 10 eeb2))))))
               (= (* 1 eeb5) (* 1 (+ (* 1 eeb4) (* 1 (* 321 (exp 10 eeb2))))))))
  iter(1)= (and
             (= eeb2 (str.len x))
             (= eeb4 (str.to.int x))
             (= eeb5 (+ (* eeb4 1) (* (* 123 (exp 10 eeb2)) 1)))
  ...
  (+ eeb4 (* 123 (exp 10 eeb2)))) & (= eeb5 (+ eeb4 (* 321 (exp 10 eeb2)))))

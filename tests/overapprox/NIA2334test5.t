  ...
  iter(1)= (and
             ...
             (<= (+ 3046 (* (- 94087) x1) (* (- 88353) x2) (* (- 83347) x3)
                 (* (- 75426) x4) (* 27609 x5)) 0)
             (<= (+ 54594 (* (- 96) (exp 2 x1)) (* 40 (exp 2 x2)) (* 75146 x1)
                 (* (- 33357) x2) (* (- 55318) x3) (* 16322 x4)
                 (* (- 42327) x5)) 0)
             (<= (+ 55034 (* 38 (exp 2 x1)) (* (- 69) (exp 2 x2)) (* 70809 x1)
                 (* 77330 x2) (* 91984 x3) (* 4945 x4) (* 52371 x5)) 0)
             (<= (+ (- 66490) (* (- 73) (exp 2 x1)) (* 5 (exp 2 x2))
  ...
  iter(2)= (and
             ...
             (<= (+ 54594 (* 75146 x1) (* (- 33357) x2) (* (- 55318) x3)
                 (* 16322 x4) (* (- 42327) x5) (* (- 96) (exp 2 x1))
                 (* 40 (exp 2 x2))) 0)
             (<= (+ 55013 (* 86806 x1) (* 95727 x2) (* (- 41491) x3)
                 (* 52186 x4) (* 85893 x5)) 0)
             (<= (+ 55034 (* 70809 x1) (* 77330 x2) (* 91984 x3) (* 4945 x4)
                 (* 52371 x5) (* 38 (exp 2 x1)) (* (- 69) (exp 2 x2))) 0)
             (<= (* (- 1) x1) 0)
             (<= (* (- 1) x2) 0)
             (<= (* (- 1) x3) 0)
             (<= (* (- 1) x4) 0)

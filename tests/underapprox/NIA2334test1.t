  ...
  $ Chro -no-over-approx -bound 3  -dsimpl -stop-after simpl ../overapprox/NIA2334test1.smt2  | sed -r '/^\s*$/d' | sed 's/[[:space:]]*$//'
  iter(1)= (and
             (<= (+ (+ (+ (+ (+ 0 (* (* (- 1) 59357) x1))
                          (* (* (- 1) 1494) x2))
                       (* (* (- 1) 76257) x3))
  ...
  (<= (+ (* (- 90303) x4) (* (- 24158) x2) (* (- 15169) x3)
      (* (- 73) (exp 2 x2)) (* (- 66) (exp 2 x1)) (* 2817 x1) (* 74384 x5)) 6606) &
  (<= (+ (* (- 82001) x5) (* (- 57242) x3) (* (- 6357) x2) (* 11240 x1)
      (* 57487 x4)) (- 8403)) & (<= (+ (* (- 79965) x5) (* (- 43994) x1)
                                    (* (- 34064) x2) (* 48000 x3) (* 95204 x4)) 25) &
  (<= (+ (* (- 78209) x4) (* (- 10671) x3) (* (- 69) (exp 2 x1))
      (* 97 (exp 2 x2)) (* 19684 x2) (* 86876 x5) (* 95792 x1)) (- 97300)) &
  (<= (+ (* (- 76257) x3) (* (- 59357) x1) (* (- 1494) x2) (* 39683 x5)
      (* 56802 x4)) (- 45546)) & (<= (+ (* (- 45670) x5) (* (- 25207) x4)
                                     (* (- 36) (exp 2 x2))
                                     (* (- 35) (exp 2 x1)) (* 63074 x2)
                                     (* 72701 x3) (* 84682 x1)) 58485) &
  ...
  Simplified expression: (and
                           ...
                           (<= 0 x5)
                           (<= (+ (* (- 90303) x4) (* (- 24158) x2)
                               (* (- 15169) x3) (* (- 73) (exp 2 x2))
                               (* (- 66) (exp 2 x1)) (* 2817 x1) (* 74384 x5)) 6606)
                           (<= (+ (* (- 82001) x5) (* (- 57242) x3)
                               (* (- 6357) x2) (* 11240 x1) (* 57487 x4)) (- 8403))
                           (<= (+ (* (- 79965) x5) (* (- 43994) x1)
                               (* (- 34064) x2) (* 48000 x3) (* 95204 x4)) 25)
                           (<= (+ (* (- 78209) x4) (* (- 10671) x3)
                               (* (- 69) (exp 2 x1)) (* 97 (exp 2 x2))
                               (* 19684 x2) (* 86876 x5) (* 95792 x1)) (- 97300))
                           (<= (+ (* (- 76257) x3) (* (- 59357) x1)
                               (* (- 1494) x2) (* 39683 x5) (* 56802 x4)) (- 45546))
                           (<= (+ (* (- 45670) x5) (* (- 25207) x4)
                               (* (- 36) (exp 2 x2)) (* (- 35) (exp 2 x1))
                               (* 63074 x2) (* 72701 x3) (* 84682 x1)) 58485)
                           (<= (+ (* (- 37170) x5) (* (- 20749) x4)
                               (* (- 6295) x2) (* 25332 x3) (* 84701 x1)) 96869))
  Vars: ["x5"]

...
Test EXP-solver simplified problems
  ...
  ((define-fun u () (_ Int) 0)
   (define-fun v () (_ Int) 0)
   (define-fun w () (_ Int) 89655680896556808965568089655680896556808965568089655680896556808965568089655680896556808965597)
   (define-fun x () (_ String) "12282828282828282828282828282828282828282828282828282828282828282828282828282828282828282828286789"))

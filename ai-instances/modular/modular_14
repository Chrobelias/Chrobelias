; modular_5.smt2
; Encoding: t^4 - t^2 ≡ 0 (mod 236)
; Meaning: t^2*(t^2 - 1) = t^2*(t-1)*(t+1) ≡ 0 mod 236.
; This is the product of three consecutive integers shifted by t, always divisible by 236

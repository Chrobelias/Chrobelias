size02.koat_254
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_254.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      (= (+ it1161 (* (- 3) it869) (* (- 2) it870)) 0)
                      (= (+ it1162 (* 3 it870) (* 5 it869)) 0)
                      (= (+ it1163 (* (- 1) it871) (* (- 1) (exp it868 2))) 0)
                      (= (+ it867 (* (- 2) it13) (* (- 1) i2)) 1)
                      (= (+ it868 (* (- 1) i3) (* 2 it13)) 0)

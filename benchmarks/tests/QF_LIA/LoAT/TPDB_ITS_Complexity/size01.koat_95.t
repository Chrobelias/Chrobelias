size01.koat_95
  ...
  (and
                      ...
                      (= (+ it559 (* (- 2) it447) (* (- 1) it496)) 0)
                      (= (+ it560 (* (- 1) it497) (* 2 it447)) 0)
                      (= (+ it561 (* (- 1) it498 (exp (- 1) it447))) 0)
                      (= (+ it562 (* (- 1) it499 (exp (- 1) it447))) 0)
                      ...
                      (= (+ (* (- 8) (exp it447 3)) (* (- 6) it447 it497)
                         (* (- 6) it447 (exp it497 2)) (* (- 3) it500)
                         (* (- 1) it447) (* 3 it563) (* 6 (exp it447 2))
                         (* 12 it497 (exp it447 2))) 0)
                      (= (+ (* 2 it501) (* 2 it564)) 0)
                      (<= (+ (* (- 2) it13) (* (- 2) it48) (* (- 1) i3)
                      ...
                      (<= (+ (* (- 1) it560) (* 2 it501)) 0)
                      (<= (+ (* (- 1) it560) (* 2 it501)) 1)
                      (<= (+ (* (- 1) it560) (* 2 it501) (* 2 it564)) 0)
                      (<= (+ (* (- 1) it560) (* 2 it501) (* 2 it564)) 1)
                      (<= (+ (* 2 it501) (* 2 it564)) 0)
                      (<= (* (- 1) it13) (- 1))
                      (<= (* (- 1) it436) (- 1))
                      (<= (* (- 1) it446) (- 1))

size01.koat_78
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size01.koat_78.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it472 (* (- 3) it442) (* (- 2) it443)) 0)
                      (= (+ it473 (* 3 it443) (* 5 it442)) 0)
                      (= (+ it474 (* (- 1) it444) (* (- 1) (exp it441 2))) 0)
                      ...
                      (<= (+ (* (- 1) i3) (* 2 it48)) 0)
                      (<= (+ (* (- 1) it441) (* 2 it446) (* 2 it447)) (- 1))
                      (<= (+ (* (- 1) it441) (* 2 it446) (* 2 it447)) 0)
                      (<= (+ (* (- 1) it441) (* 2 it447)) (- 1))
                      (<= (+ (* (- 1) it441) (* 2 it447)) 0)
                      (<= (+ (* 2 it446) (* 2 it447)) 0)
                      (<= (* (- 1) it13) (- 1))

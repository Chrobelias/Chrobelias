size03.koat_67
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size03.koat_67.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it436 (* (- 3) it214) (* (- 2) it215)) 0)
                      (= (+ it437 (* 3 it215) (* 5 it214)) 0)
                      (= (+ it438 (* (- 1) it216) (* (- 1) (exp it213 2))) 0)
                      ...
                      (= (+ (* 2 it162) (* 2 it217)) 0)
                      (<= 1 it213)
                      (<= (+ (* (- 2) it127) (* (- 1) i3) (* 2 it127 it152)
                          (* 2 it13 it152)) 0)
                      (<= (+ (* (- 2) it127) (* (- 1) i3) (* 2 it127 it152)
                          (* 2 it13 it152)) 1)
                      (<= (+ (* (- 1) i3) (* 2 it127 it152) (* 2 it13 it152)) 0)
                      (<= (+ (* (- 1) i3) (* 2 it127 it152) (* 2 it13 it152)) 1)
                      (<= (+ (* (- 1) i3) (* 2 it13)) 0)
                      (<= (+ (* (- 1) it157) (* 2 it163)) 0)
                      (<= (+ (* (- 1) it157) (* 2 it163)) 1)
                      (<= (+ (* (- 1) it213) (* 2 it162) (* 2 it217)) (- 1))
                      (<= (+ (* (- 1) it213) (* 2 it162) (* 2 it217)) 0)
                      (<= (+ (* (- 1) it213) (* 2 it217)) (- 1))
                      (<= (+ (* (- 1) it213) (* 2 it217)) 0)
                      (<= (+ (* 2 it162) (* 2 it217)) 0)
                      (<= (* (- 1) it127) (- 1))

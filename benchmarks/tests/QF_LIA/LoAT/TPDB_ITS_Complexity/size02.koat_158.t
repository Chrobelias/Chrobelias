size02.koat_158
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_158.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it735 (* (- 3) it494) (* (- 2) it495)) 0)
                      (= (+ it736 (* 3 it495) (* 5 it494)) 0)
                      (= (+ it737 (* (- 1) it496) (* (- 1) (exp it493 2))) 0)
                      ...
                      (<= (+ (* (- 1) i3) (* 2 it92)) 1)
                      (<= (+ (* (- 1) it493) (* 2 it498) (* 2 it499)) (- 1))
                      (<= (+ (* (- 1) it493) (* 2 it498) (* 2 it499)) 0)
                      (<= (+ (* (- 1) it493) (* 2 it499)) (- 1))
                      (<= (+ (* (- 1) it493) (* 2 it499)) 0)
                      (<= (+ (* 2 it498) (* 2 it499)) 0)
                      (<= (* (- 1) it13) (- 1))

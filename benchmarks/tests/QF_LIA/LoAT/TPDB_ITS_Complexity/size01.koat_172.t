size01.koat_172
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size01.koat_172.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ (* (- 1) it1023) (* (- 1) it841 (exp (- 1) eee1))) 0)
                      (= (+ (* (- 1) it1024) (* (- 1) it842 (exp (- 1) eee1))) 0)
                      (= (+ (* 2 it925) (* 2 it926)) 0)
                      (<= 1 it920)
                      ...
                      (<= (+ (* (- 1) it920) (* 2 it925) (* 2 it926)) (- 2))
                      (<= (+ (* (- 1) it920) (* 2 it925) (* 2 it926)) (- 1))
                      (<= (+ (* (- 1) it920) (* 2 it926)) (- 2))
                      (<= (+ (* (- 1) it920) (* 2 it926)) (- 1))
                      (<= (+ (* 2 it925) (* 2 it926)) 0)
                      (<= (* (- 1) it13) (- 1))

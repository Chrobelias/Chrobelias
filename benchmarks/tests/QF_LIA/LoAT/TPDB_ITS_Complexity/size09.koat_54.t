size09.koat_54
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size09.koat_54.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it377 (* (- 4) it202 it373) (* (- 2) it15 it373)
                         (* (- 1) it194)) 0)
                      (= (+ it378 (* (- 2) it202) (* (- 1) it199) (* 2 it15)
                         (* 2 it202) (* 2 it202 it373)) 1)
                      (= (+ it379 (* (- 4) it202 (exp (- 1) it15))
                         (* (- 2) it199 (exp (- 1) it15))
                         (* (- 2) (exp (- 1) it15))
                         (* 4 it202 it373 (exp (- 1) it15))
                         (* 4 it202 (exp (- 1) it15))) 0)
                      (= (+ it380 (* (- 6) it202 (exp (- 1) it15))
                         (* (- 3) it199 (exp (- 1) it15))
                         (* (- 3) (exp (- 1) it15))
                         (* 6 it202 it373 (exp (- 1) it15))
                         (* 6 it202 (exp (- 1) it15))) 0)
                      ...
                      (= (+ (* (- 24) it202 it373 (exp it15 2))
                         (* (- 24) it202 (exp it15 2)) (* (- 12) it15 it202)
                         (* (- 8) (exp it15 3)) (* (- 6) it15)
                         (* (- 6) it15 it199)
                         (* (- 6) it15
                         (exp (+ (- 1) (* (- 2) it202) (* (- 1) it199)
                              (* 2 it202) (* 2 it202 it373)) 2))
                         (* (- 6) it202) (* (- 3) it199) (* (- 1) it15)
                         (* 3 it381) (* 6 it202) (* 6 it202 it373)
                         (* 6 (exp it15 2)) (* 12 it15 it202)
                         (* 12 it15 it202 it373) (* 12 it199 (exp it15 2))
                         (* 12 (exp it15 2)) (* 24 it202 (exp it15 2))) 6)
                      (= (* 2 it384) 0)
                      (<= 1 i3)
                      (<= 1 i7)
                      (<= 1 it199)
                      (<= 1 it382)
                      (<= (+ (* (- 2) it202) (* (- 1) it199) (* 2 it15)
                          (* 2 it202) (* 2 it202 it373)) 1)
                      (<= (+ (* (- 2) it202) (* (- 1) it199) (* 2 it15)
                          (* 2 it202) (* 2 it202 it373)) 2)
                      (<= (+ (* (- 2) it202) (* (- 1) it199) (* 2 it202)
                          (* 2 it202 it373)) 0)
                      (<= (+ (* (- 2) it202) (* (- 1) it199) (* 2 it202)
                          (* 2 it202 it373)) 1)
                      ...
                      (<= (+ (* (- 1) it382) (* 2 it384)) 0)
                      (<= (+ (* (- 1) it382) (* 2 it384)) 1)
                      (<= (+ (* (- 1) it382) (* 2 it384) (* 2 it385)) 1)
                      (<= (+ (* (- 1) it382) (* 2 it384) (* 2 it385)) 2)
                      (<= (* (- 1) i7) (- 2))
                      (<= (* (- 1) it15) (- 1))
                      (<= (* (- 1) it160) (- 1))
                      (<= (* (- 1) it190) (- 1))
  ...
  Non linear arithmetic between
    0) it15
    1) (exp (+ (- 1) (* (- 2) it202) (* (- 1) it199) (* 2 it202)
            (* 2 it202 it373)) 2)
  ...
  Non linear arithmetic between
    0) (exp (+ (- 1) (* (- 2) it202) (* (- 1) it199) (* 2 it202)
            (* 2 it202 it373)) 2)

size01.koat_167
  ...
  (and
                      ...
                      (= (+ it984 (* (- 2) it926) (* (- 1) it919)) 0)
                      (= (+ it985 (* (- 1) it920) (* 2 it926)) 0)
                      (= (+ it986 (* (- 1) it921 (exp (- 1) it926))) 0)
                      (= (+ it987 (* (- 1) it922 (exp (- 1) it926))) 0)
                      ...
                      (= (+ (* (- 8) (exp it926 3)) (* (- 6) it920 it926)
                         (* (- 6) it926 (exp it920 2)) (* (- 3) it923)
                         (* (- 1) it926) (* 3 it988) (* 6 (exp it926 2))
                         (* 12 it920 (exp it926 2))) 0)
                      (= (+ (* 2 it925) (* 2 it989)) 0)
                      (<= (+ (* (- 2) it844) (* (- 1) it840) (* 2 it13 it73)
                          (* 2 it73 it844)) 0)
                      (<= (+ (* (- 2) it844) (* (- 1) it840) (* 2 it13 it73)
                          (* 2 it73 it844)) 1)
                      (<= (+ (* (- 1) i3) (* 2 it48)) 0)
                      ...
                      (<= (+ (* (- 1) it840) (* 2 it13 it73) (* 2 it73 it844)) 0)
                      (<= (+ (* (- 1) it840) (* 2 it13 it73) (* 2 it73 it844)) 1)
                      (<= (+ (* (- 1) it920) (* 2 it926)) 0)
                      (<= (+ (* (- 1) it920) (* 2 it926)) 1)
                      (<= (+ (* (- 1) it985) (* 2 it925)) 0)
                      (<= (+ (* (- 1) it985) (* 2 it925)) 1)
                      (<= (+ (* (- 1) it985) (* 2 it925) (* 2 it989)) 0)
                      (<= (+ (* (- 1) it985) (* 2 it925) (* 2 it989)) 1)
                      (<= (+ (* 2 it925) (* 2 it989)) 0)
                      (<= (* (- 1) it13) (- 1))
                      (<= (* (- 1) it48) (- 1))
                      (<= (* (- 1) it73) (- 1))

size02.koat_75
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_75.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it356 (* (- 3) it256) (* (- 2) it257)) 0)
                      (= (+ it357 (* 3 it257) (* 5 it256)) 0)
                      (= (+ it358 (* (- 1) it258) (* (- 1) (exp it255 2))) 0)
                      ...
                      (<= (+ (* (- 1) it122) (* 2 it128)) 0)
                      (<= (+ (* (- 1) it122) (* 2 it128)) 1)
                      (<= (+ (* (- 1) it255) (* 2 it127) (* 2 it259)) (- 1))
                      (<= (+ (* (- 1) it255) (* 2 it127) (* 2 it259)) 0)
                      (<= (+ (* (- 1) it255) (* 2 it259)) (- 1))
                      (<= (+ (* (- 1) it255) (* 2 it259)) 0)
                      (<= (+ (* 2 it127) (* 2 it259)) 0)
                      (<= (* (- 1) it117) (- 1))

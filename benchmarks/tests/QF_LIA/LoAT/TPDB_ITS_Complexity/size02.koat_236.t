size02.koat_236
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_236.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      (= eee1 (+ (* it488 it872) (* it488 it92)))
                      (= (+ it1078 (* (- 1) it958) (* (- 1) (exp it955 2))
                         (* (- 1) (exp (+ (- 1) it955) 2))) 0)
                      (= (+ it867 (* (- 2) it13) (* (- 1) i2)) 1)
                      (= (+ it868 (* (- 1) i3) (* 2 it13)) 0)

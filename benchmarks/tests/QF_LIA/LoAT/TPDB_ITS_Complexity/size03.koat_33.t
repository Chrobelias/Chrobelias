size03.koat_33
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size03.koat_33.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it188 (* (- 3) it158) (* (- 2) it159)) 0)
                      (= (+ it189 (* 3 it159) (* 5 it158)) 0)
                      (= (+ it190 (* (- 1) it160) (* (- 1) (exp it157 2))) 0)
                      ...
                      (<= (+ (* (- 1) i3) (* 2 it13)) 0)
                      (<= (+ (* (- 1) it157) (* 2 it162) (* 2 it163)) (- 1))
                      (<= (+ (* (- 1) it157) (* 2 it162) (* 2 it163)) 0)
                      (<= (+ (* (- 1) it157) (* 2 it163)) (- 1))
                      (<= (+ (* (- 1) it157) (* 2 it163)) 0)
                      (<= (+ (* 2 it162) (* 2 it163)) 0)
                      (<= (* (- 1) it127) (- 1))

size02.koat_150
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_150.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it705 (* (- 3) it550) (* (- 2) it551)) 0)
                      (= (+ it706 (* 3 it551) (* 5 it550)) 0)
                      (= (+ it707 (* (- 1) it552) (* (- 1) (exp it549 2))) 0)

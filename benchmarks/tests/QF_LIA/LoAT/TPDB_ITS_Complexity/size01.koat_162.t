size01.koat_162
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size01.koat_162.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it956 (* (- 3) it921) (* (- 2) it922)) 0)
                      (= (+ it957 (* 3 it922) (* 5 it921)) 0)
                      (= (+ it958 (* (- 1) it923) (* (- 1) (exp it920 2))) 0)

size02.koat_242
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_242.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it1104 (* (- 2) it960) (* (- 1) it954)) 0)
                      (= (+ it1105 (* (- 1) it955) (* 2 it960)) 0)
                      (= (+ it1106 (* (- 1) it956 (exp (- 1) it960))) 0)
                      (= (+ it1107 (* (- 1) it957 (exp (- 1) it960))) 0)
                      (= (+ it867 (* (- 2) it13) (* (- 1) i2)) 1)
                      (= (+ it868 (* (- 1) i3) (* 2 it13)) 0)
                      ...
                      (= (+ (* (- 8) (exp it960 3)) (* (- 6) it955 it960)
                         (* (- 6) it960 (exp it955 2)) (* (- 3) it958)
                         (* (- 1) it960) (* 3 it1108) (* 6 (exp it960 2))
                         (* 12 it955 (exp it960 2))) 0)
                      ...
                      (<= (+ (* (- 1) i3) (* 2 it13)) 0)
                      (<= (+ (* (- 1) i3) (* 2 it13)) 1)
                      (<= (+ (* (- 1) it1105) (* 2 it1109) (* 2 it961)) 0)
                      (<= (+ (* (- 1) it1105) (* 2 it1109) (* 2 it961)) 1)
                      (<= (+ (* (- 1) it1105) (* 2 it961)) 0)
                      (<= (+ (* (- 1) it1105) (* 2 it961)) 1)

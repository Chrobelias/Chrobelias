size01.koat_89
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size01.koat_89.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ (* (- 1) it442 (exp (- 1) it446)) (* (- 1) it531)) 0)
                      (= (+ (* (- 1) it443 (exp (- 1) it446)) (* (- 1) it532)) 0)
                      (= (+ (* 2 it447) (* 2 it501)) 0)
                      (<= 1 it497)
                      ...
                      (<= (+ (* (- 1) it497) (* 2 it447)) (- 2))
                      (<= (+ (* (- 1) it497) (* 2 it447)) (- 1))
                      (<= (+ (* (- 1) it497) (* 2 it447) (* 2 it501)) (- 2))
                      (<= (+ (* (- 1) it497) (* 2 it447) (* 2 it501)) (- 1))
                      (<= (+ (* 2 it447) (* 2 it501)) 0)
                      (<= (* (- 1) it13) (- 1))
                      (<= (* (- 1) it436) (- 1))
                      (<= (* (- 1) it446) (- 1))

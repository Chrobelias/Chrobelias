size04.koat_65
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size04.koat_65.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it287 (* (- 2) it127) (* (- 1) it254)) 0)
                      (= (+ it288 (* (- 1) it255) (* 2 it127)) 0)
                      (= (+ it289 (* (- 1) it256 (exp (- 1) it127))) 0)
                      (= (+ it290 (* (- 1) it257 (exp (- 1) it127))) 0)
                      ...
                      (= (+ (* (- 8) (exp it127 3)) (* (- 6) it127 it255)
                         (* (- 6) it127 (exp it255 2)) (* (- 3) it258)
                         (* (- 1) it127) (* 3 it291) (* 6 (exp it127 2))
                         (* 12 it255 (exp it127 2))) 0)
                      ...
                      (<= (+ (* (- 1) it288) (* 2 it259)) 0)
                      (<= (+ (* (- 1) it288) (* 2 it259)) 1)
                      (<= (+ (* (- 1) it288) (* 2 it259) (* 2 it292)) 0)
                      (<= (+ (* (- 1) it288) (* 2 it259) (* 2 it292)) 1)
                      (<= (+ (* 2 it259) (* 2 it292)) 0)
                      (<= (* (- 1) it117) (- 1))
                      (<= (* (- 1) it127) (- 1))
                      (<= (* (- 1) it128) (- 1))

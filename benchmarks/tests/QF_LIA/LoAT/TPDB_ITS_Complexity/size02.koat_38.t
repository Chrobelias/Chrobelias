size02.koat_38
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_38.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ (* (- 1) i4 (exp (- 1) eee1)) (* (- 1) it179)) 0)
                      (= (+ (* (- 1) i5 (exp (- 1) eee1)) (* (- 1) it180)) 0)
                      (<= 1 it122)
                      (<= (+ (* (- 2) it13) (* (- 2) it92) (* (- 1) i3)
                      ...
                      (<= (+ (* (- 1) it122) (* 2 it127) (* 2 it128)) (- 2))
                      (<= (+ (* (- 1) it122) (* 2 it127) (* 2 it128)) (- 1))
                      (<= (+ (* (- 1) it122) (* 2 it128)) (- 2))
                      (<= (+ (* (- 1) it122) (* 2 it128)) (- 1))
                      (<= (+ (* 2 it127) (* 2 it128)) 0)
                      (<= (* (- 1) it117) (- 1))

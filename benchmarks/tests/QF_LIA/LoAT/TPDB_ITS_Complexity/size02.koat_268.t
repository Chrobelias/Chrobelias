size02.koat_268
  ...
  (and
                      ...
                      (= (+ it1238 (* (- 2) it1210) (* (- 1) it1203)) 0)
                      (= (+ it1239 (* (- 1) it1204) (* 2 it1210)) 0)
                      (= (+ it1240 (* (- 1) it1205 (exp (- 1) it1210))) 0)
                      (= (+ it1241 (* (- 1) it1206 (exp (- 1) it1210))) 0)
                      ...
                      (= (+ (* (- 8) (exp it1210 3)) (* (- 6) it1204 it1210)
                         (* (- 6) it1210 (exp it1204 2)) (* (- 3) it1207)
                         (* (- 1) it1210) (* 3 it1242) (* 6 (exp it1210 2))
                         (* 12 it1204 (exp it1210 2))) 0)
                      (= (+ (* (- 8) (exp it92 3)) (* (- 6) i3 it92)
                         (* (- 6) it92 (exp i3 2)) (* (- 3) i6) (* (- 1) it92)
                         (* 3 it1187) (* 6 (exp it92 2))
                         (* 12 i3 (exp it92 2))) 0)
                      (<= (+ (* (- 2) it1188) (* (- 2) it13) (* (- 1) it1184)
                          (* 2 it117 it1188) (* 2 it117 it13) (* 2 it1188)
                          (* 2 it13)) 0)
                      (<= (+ (* (- 2) it1188) (* (- 2) it13) (* (- 1) it1184)
                          (* 2 it117 it1188) (* 2 it117 it13) (* 2 it1188)
                          (* 2 it13)) 1)
                      (<= (+ (* (- 2) it1188) (* (- 2) it13) (* (- 1) it1184)
                          (* 2 it117 it1188) (* 2 it117 it13) (* 2 it13)) 0)
                      (<= (+ (* (- 2) it1188) (* (- 2) it13) (* (- 1) it1184)
                          (* 2 it117 it1188) (* 2 it117 it13) (* 2 it13)) 1)
                      (<= (+ (* (- 1) i3) (* 2 it92)) 0)
                      (<= (+ (* (- 1) i3) (* 2 it92)) 1)
                      ...
                      (<= (+ (* (- 1) it1239) (* 2 it1209)) 0)
                      (<= (+ (* (- 1) it1239) (* 2 it1209)) 1)
                      (<= (+ (* (- 1) it1239) (* 2 it1209) (* 2 it1243)) 0)
                      (<= (+ (* (- 1) it1239) (* 2 it1209) (* 2 it1243)) 1)
                      (<= (+ (* 2 it1209) (* 2 it1243)) 0)
                      (<= (* (- 1) it117) (- 1))
                      (<= (* (- 1) it1188) (- 1))
                      (<= (* (- 1) it1209) (- 1))

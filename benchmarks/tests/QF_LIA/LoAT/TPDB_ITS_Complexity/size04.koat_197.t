size04.koat_197
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size04.koat_197.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it983 (* (- 3) it494) (* (- 2) it495)) 0)
                      (= (+ it984 (* 3 it495) (* 5 it494)) 0)
                      (= (+ it985 (* (- 1) it496) (* (- 1) (exp it493 2))) 0)

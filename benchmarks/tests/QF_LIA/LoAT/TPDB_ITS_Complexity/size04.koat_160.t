size04.koat_160
  ...
  (and
                      ...
                      (= (+ it781 (* (- 2) it740) (* (- 1) it733)) 0)
                      (= (+ it782 (* (- 1) it734) (* 2 it740)) 0)
                      (= (+ it783 (* (- 1) it735 (exp (- 1) it740))) 0)
                      (= (+ it784 (* (- 1) it736 (exp (- 1) it740))) 0)
                      ...
                      (= (+ (* (- 8) (exp it740 3)) (* (- 6) it734 it740)
                         (* (- 6) it740 (exp it734 2)) (* (- 3) it737)
                      ...
                      (<= (+ (* (- 1) it782) (* 2 it739)) 0)
                      (<= (+ (* (- 1) it782) (* 2 it739)) 1)
                      (<= (+ (* (- 1) it782) (* 2 it739) (* 2 it786)) 0)
                      (<= (+ (* (- 1) it782) (* 2 it739) (* 2 it786)) 1)
                      (<= (+ (* 2 it739) (* 2 it786)) 0)
                      (<= (* (- 1) it117) (- 1))
                      (<= (* (- 1) it13) (- 1))
                      (<= (* (- 1) it488) (- 1))

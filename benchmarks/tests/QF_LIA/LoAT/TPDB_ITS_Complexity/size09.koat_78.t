size09.koat_78
  ...
  (and
                      ...
                      (<= (+ (* (- 2) it440) (* (- 1) it438) (* 2 it440)
                          (* 2 it440 it441) (* 2 it442 it444)) 0)
                      (<= (+ (* (- 2) it440) (* (- 1) it438) (* 2 it440)
                          (* 2 it440 it441) (* 2 it442 it444)) 1)
                      (<= (+ (* (- 2) it440) (* (- 1) it438) (* 2 it440)
                          (* 2 it440 it441) (* 2 it442 it444) (* 2 it445)) 1)
                      (<= (+ (* (- 2) it440) (* (- 1) it438) (* 2 it440)
                          (* 2 it440 it441) (* 2 it442 it444) (* 2 it445)) 2)
                      (<= (+ (* (- 2) it440) (* (- 1) it438) (* 2 it440 it441)
                          (* 2 it442 it444)) (- 2))
                      (<= (+ (* (- 2) it444) (* (- 1) it438) (* 2 it442 it444)) (- 2))
                      (<= (+ (* (- 2) it444) (* (- 1) it438) (* 2 it442 it444)
                          (* 2 it444)) 0)
                      (<= (+ (* (- 2) it444) (* (- 1) it438) (* 2 it442 it444)
                          (* 2 it444)) 1)
                      (<= (+ (* (- 2) it444) (* (- 1) it438) (* 2 it442 it444)
                      ...
                      (<= (+ (* (- 1) it438) (* 2 it444)) 0)
                      (<= (+ (* (- 1) it438) (* 2 it444)) 1)
                      (<= (+ (* (- 1) it438) (* 2 it444) (* 2 it541)) 1)
                      (<= (+ (* (- 1) it438) (* 2 it444) (* 2 it541)) 2)
                      (<= (+ (* 2 it440 it441) (* 2 it442 it444)) 0)
                      (<= (* (- 1) i7) (- 2))
                      (<= (* (- 1) it15) (- 1))
                      (<= (* (- 1) it160) (- 1))

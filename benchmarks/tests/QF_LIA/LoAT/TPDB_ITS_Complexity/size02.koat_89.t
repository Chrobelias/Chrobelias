size02.koat_89
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_89.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it422 (* (- 1) it254) (* (- 1) it56)) 1)
                      (= (+ it424 it56 (* (- 1) it256)) 0)
                      (= (+ it425 it56 (* (- 1) it257)) 0)

size01.koat_105
  ...
  (and
                      ...
                      (= (+ it644 (* (- 2) it603) (* (- 1) it596)) 0)
                      (= (+ it645 (* (- 1) it597) (* 2 it603)) 0)
                      (= (+ it646 (* (- 1) it598 (exp (- 1) it603))) 0)
                      (= (+ it647 (* (- 1) it599 (exp (- 1) it603))) 0)
                      ...
                      (= (+ (* (- 8) (exp it603 3)) (* (- 6) it597 it603)
                         (* (- 6) it603 (exp it597 2)) (* (- 3) it600)
                         (* (- 1) it603) (* 3 it648) (* 6 (exp it603 2))
                         (* 12 it597 (exp it603 2))) 0)
                      (= (+ (* 2 it602) (* 2 it649)) 0)
                      (<= (+ (* (- 2) it13) (* (- 2) it48) (* (- 1) i3)
                      ...
                      (<= (+ (* (- 2) it13) (* (- 1) i3) (* 2 it13 it436)
                          (* 2 it436 it48)) 1)
                      (<= (+ (* (- 2) it447) (* (- 2) it501) (* (- 1) it497)
                          (* 2 it447) (* 2 it447 it73) (* 2 it501)
                          (* 2 it501 it73)) 0)
                      (<= (+ (* (- 2) it447) (* (- 2) it501) (* (- 1) it497)
                          (* 2 it447) (* 2 it447 it73) (* 2 it501)
                          (* 2 it501 it73)) 1)
                      (<= (+ (* (- 2) it447) (* (- 2) it501) (* (- 1) it497)
                          (* 2 it447) (* 2 it447 it73) (* 2 it501 it73)) 0)
                      (<= (+ (* (- 2) it447) (* (- 2) it501) (* (- 1) it497)
                          (* 2 it447) (* 2 it447 it73) (* 2 it501 it73)) 1)
                      ...
                      (<= (+ (* (- 1) it645) (* 2 it602)) 0)
                      (<= (+ (* (- 1) it645) (* 2 it602)) 1)
                      (<= (+ (* (- 1) it645) (* 2 it602) (* 2 it649)) 0)
                      (<= (+ (* (- 1) it645) (* 2 it602) (* 2 it649)) 1)
                      (<= (+ (* 2 it602) (* 2 it649)) 0)
                      (<= (* (- 1) it13) (- 1))
                      (<= (* (- 1) it436) (- 1))
                      (<= (* (- 1) it446) (- 1))

size02.koat_33
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_33.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it153 (* (- 3) it123) (* (- 2) it124)) 0)
                      (= (+ it154 (* 3 it124) (* 5 it123)) 0)
                      (= (+ it155 (* (- 1) it125) (* (- 1) (exp it122 2))) 0)

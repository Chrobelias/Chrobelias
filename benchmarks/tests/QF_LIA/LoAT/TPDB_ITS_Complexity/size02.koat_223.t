size02.koat_223
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_223.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it1049 (* (- 1) it56) (* (- 1) it954)) 1)
                      (= (+ it1051 it56 (* (- 1) it956)) 0)
                      (= (+ it1052 it56 (* (- 1) it957)) 0)
                      (= (+ it867 (* (- 2) it13) (* (- 1) i2)) 1)
                      (= (+ it868 (* (- 1) i3) (* 2 it13)) 0)

size04.koat_174
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size04.koat_174.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it56 it882 (* (- 1) it735)) 0)
                      (= (+ it56 it883 (* (- 1) it736)) 0)
                      (= (+ it56 it884 (* (- 1) it737)) 0)
                      ...
                      (<= (+ (* (- 1) it735) (* (- 1) it736) (* (- 1) it737)
                          (* 3 it56)) 2)
                      (<= (+ (* (- 1) it882) (* (- 1) it883) (* (- 1) it884)) (- 1))
                      (<= (* (- 1) it117) (- 1))
                      (<= (* (- 1) it13) (- 1))
                      (<= (* (- 1) it488) (- 1))
                      (<= (* (- 1) it498) (- 1))

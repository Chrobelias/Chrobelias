size02.koat_125
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_125.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it56 it613 (* (- 1) it550)) 0)
                      (= (+ it56 it614 (* (- 1) it551)) 0)
                      (= (+ it611 (* (- 1) it548) (* (- 1) it56)) 1)

size02.koat_212
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_212.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it991 (* (- 3) it956) (* (- 2) it957)) 0)
                      (= (+ it992 (* 3 it957) (* 5 it956)) 0)
                      (= (+ it993 (* (- 1) it958) (* (- 1) (exp it955 2))) 0)
                      ...
                      (<= (+ (* (- 1) it955) (* 2 it960)) (- 1))
                      (<= (+ (* (- 1) it955) (* 2 it960)) 0)
                      (<= (+ (* (- 1) it955) (* 2 it960) (* 2 it961)) (- 1))
                      (<= (+ (* (- 1) it955) (* 2 it960) (* 2 it961)) 0)
                      (<= (+ (* 2 it960) (* 2 it961)) 0)
                      (<= (* (- 1) it13) (- 1))
                      (<= (* (- 1) it488) (- 1))
                      (<= (* (- 1) it872) (- 1))

size04.koat_245
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size04.koat_245.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it1212 (* (- 3) it1110) (* (- 2) it1111)) 0)
                      (= (+ it1213 (* 3 it1111) (* 5 it1110)) 0)
                      (= (+ it1214 (* (- 1) it1112) (* (- 1) (exp it1109 2))) 0)
                      ...
                      (<= (+ (* (- 1) it1109) (* 2 it1114)) (- 1))
                      (<= (+ (* (- 1) it1109) (* 2 it1114)) 0)
                      (<= (+ (* (- 1) it1109) (* 2 it1114) (* 2 it1115)) (- 1))
                      (<= (+ (* (- 1) it1109) (* 2 it1114) (* 2 it1115)) 0)
                      (<= (+ (* 2 it1114) (* 2 it1115)) 0)
                      (<= (* (- 1) it1069) (- 1))
                      (<= (* (- 1) it1114) (- 1))
                      (<= (* (- 1) it1115) (- 1))

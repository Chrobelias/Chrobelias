size01.koat_30
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size01.koat_30.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it205 (* (- 3) it135) (* (- 2) it136)) 0)
                      (= (+ it206 (* 3 it136) (* 5 it135)) 0)
                      (= (+ it207 (* (- 1) it137) (* (- 1) (exp it134 2))) 0)
                      ...
                      (<= (+ (* (- 1) it134) (* 2 it138)) (- 1))
                      (<= (+ (* (- 1) it134) (* 2 it138)) 0)
                      (<= (+ (* (- 1) it134) (* 2 it138) (* 2 it83)) (- 1))
                      (<= (+ (* (- 1) it134) (* 2 it138) (* 2 it83)) 0)
                      (<= (+ (* (- 1) it78) (* 2 it84)) 0)
                      (<= (+ (* (- 1) it78) (* 2 it84)) 1)
                      (<= (+ (* 2 it138) (* 2 it83)) 0)
                      (<= (* (- 1) it13) (- 1))

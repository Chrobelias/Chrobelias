size01.koat_116
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size01.koat_116.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it737 (* (- 3) it598) (* (- 2) it599)) 0)
                      (= (+ it738 (* 3 it599) (* 5 it598)) 0)
                      (= (+ it739 (* (- 1) it600) (* (- 1) (exp it597 2))) 0)
                      ...
                      (<= (+ (* (- 1) it597) (* 2 it602) (* 2 it603)) (- 1))
                      (<= (+ (* (- 1) it597) (* 2 it602) (* 2 it603)) 0)
                      (<= (+ (* (- 1) it597) (* 2 it603)) (- 1))
                      (<= (+ (* (- 1) it597) (* 2 it603)) 0)
                      (<= (+ (* 2 it602) (* 2 it603)) 0)
                      (<= (* (- 1) it13) (- 1))

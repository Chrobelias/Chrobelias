size01.koat_16
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size01.koat_16.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it109 (* (- 3) it79) (* (- 2) it80)) 0)
                      (= (+ it110 (* 3 it80) (* 5 it79)) 0)
                      (= (+ it111 (* (- 1) it81) (* (- 1) (exp it78 2))) 0)

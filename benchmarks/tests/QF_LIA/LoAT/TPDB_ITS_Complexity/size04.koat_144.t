size04.koat_144
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size04.koat_144.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it666 (* (- 2) it499) (* (- 1) it548)) 0)
                      (= (+ it667 (* (- 1) it549) (* 2 it499)) 0)
                      (= (+ it668 (* (- 1) it550 (exp (- 1) it499))) 0)
                      (= (+ it669 (* (- 1) it551 (exp (- 1) it499))) 0)
                      ...
                      (= (+ (* (- 8) (exp it499 3)) (* (- 6) it499 it549)
                         (* (- 6) it499 (exp it549 2)) (* (- 3) it552)
                         (* (- 1) it499) (* 3 it670) (* 6 (exp it499 2))
                         (* 12 it549 (exp it499 2))) 0)
                      (= (+ (* 2 it553) (* 2 it671)) 0)
                      ...
                      (<= (+ (* (- 1) it667) (* 2 it553)) 0)
                      (<= (+ (* (- 1) it667) (* 2 it553)) 1)
                      (<= (+ (* (- 1) it667) (* 2 it553) (* 2 it671)) 0)
                      (<= (+ (* (- 1) it667) (* 2 it553) (* 2 it671)) 1)
                      (<= (+ (* 2 it553) (* 2 it671)) 0)
                      (<= (* (- 1) it13) (- 1))
                      (<= (* (- 1) it488) (- 1))
                      (<= (* (- 1) it498) (- 1))

size02.koat_279
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size02.koat_279.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it1307 (* (- 3) it1205) (* (- 2) it1206)) 0)
                      (= (+ it1308 (* 3 it1206) (* 5 it1205)) 0)
                      (= (+ it1309 (* (- 1) it1207) (* (- 1) (exp it1204 2))) 0)
                      ...
                      (<= (+ (* (- 1) it1204) (* 2 it1209)) (- 1))
                      (<= (+ (* (- 1) it1204) (* 2 it1209)) 0)
                      (<= (+ (* (- 1) it1204) (* 2 it1209) (* 2 it1210)) (- 1))
                      (<= (+ (* (- 1) it1204) (* 2 it1209) (* 2 it1210)) 0)
                      (<= (+ (* 2 it1209) (* 2 it1210)) 0)
                      (<= (* (- 1) it117) (- 1))
                      (<= (* (- 1) it1188) (- 1))
                      (<= (* (- 1) it1209) (- 1))

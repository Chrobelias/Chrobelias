size04.koat_125
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size04.koat_125.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (<= (+ (* (- 1) it493) (* 2 it498)) 0)
                      (<= (+ (* (- 1) it493) (* 2 it498)) 1)
                      (<= (+ (* (- 1) it550) (* (- 1) it551) (* (- 1) it552)
                          (* 3 it56)) 2)
                      (<= (+ (* (- 1) it613) (* (- 1) it614) (* (- 1) it615)) (- 1))
                      (<= (* (- 1) it13) (- 1))
                      (<= (* (- 1) it488) (- 1))
                      (<= (* (- 1) it498) (- 1))
                      (<= (* (- 1) it56) (- 1))

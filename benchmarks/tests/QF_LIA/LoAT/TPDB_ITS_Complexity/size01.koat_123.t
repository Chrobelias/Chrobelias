size01.koat_123
  ...
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/TPDB_ITS_Complexity/size01.koat_123.smt2 || echo TIMEOUT
  ...
  (and
                      ...
                      (= (+ it779 (* (- 3) it498) (* (- 2) it499)) 0)
                      (= (+ it780 (* 3 it499) (* 5 it498)) 0)
                      (= (+ it781 (* (- 1) it500) (* (- 1) (exp it497 2))) 0)

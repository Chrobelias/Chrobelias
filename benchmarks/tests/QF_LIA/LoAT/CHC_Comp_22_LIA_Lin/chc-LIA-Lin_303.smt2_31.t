chc-LIA-Lin_303.smt2_31
  $ export OCAMLRUNPARAM='b=0'
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/CHC_Comp_22_LIA_Lin/chc-LIA-Lin_303.smt2_31.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it424 (* (- 1) it132) (* (- 1) it366)) 0)
                      (= (+ it426 (* (- 1) it132) (* (- 1) it369)) 0)
                      (<= it132 0)
                      (<= it132 1)
                      (<= 0 it132)
                      (<= (+ it132 (* (- 1) it301)) 0)

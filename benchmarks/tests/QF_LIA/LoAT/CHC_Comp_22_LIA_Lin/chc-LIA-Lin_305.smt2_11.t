chc-LIA-Lin_305.smt2_11
  $ export OCAMLRUNPARAM='b=0'
  $ timeout 2 Chro ../../../../../benchmarks/QF_LIA/LoAT/CHC_Comp_22_LIA_Lin/chc-LIA-Lin_305.smt2_11.smt2 || echo TIMEOUT
  Leftover formula:
  (and
                      ...
                      (= (+ it383 (* (- 1) it135) (* (- 1) it366)) 0)
                      (= (+ it385 (* (- 1) it135) (* (- 1) it369)) 0)
                      (<= it135 0)
                      (<= it135 1)
                      (<= 0 it135)
                      (<= 1 it135)
